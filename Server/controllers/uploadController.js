...
// const audioFilter = createFileFilter([
//   "audio/mpeg",
//   "audio/mp3",
//   "audio/wav",
//   "audio/webm",
...
// // Story media upload (supports multiple file types)
// const storyMediaFields = [
...
//       cb(
//         new Error(
//           `Invalid file type: ${file.mimetype}. Allowed types: images, audio, video`,
//         ),
//         false,
//       );
//     }
//   },
//   limits: {
//     fileSize: 100 * 1024 * 1024, // 100MB limit (highest for video)
//   },
// });
...
// // Story media upload (images, audio, video)
// export const uploadStoryMedia = (req, res, next) => {
//   storyMediaUpload.fields(storyMediaFields)(req, res, (err) => {
//     if (err) {
//       return res.status(400).json({
//         status: "error",
//         message: err.message || "Story media upload failed",
//       });
//     }
//     next();
//   });
