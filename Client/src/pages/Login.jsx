...
//   const from = (location.state && location.state.from && location.state.from.pathname) || ROUTES.DASHBOARD;
...
// import { toast, useToast } from "@/hooks/use-toast"; // adjust path accordingly

// export const Login = () => {
//   const navigate = useNavigate();
//   const location = useLocation();
//   const { isAuthenticated, login, clearError } = useAuthContext();
//   const [showPassword, setShowPassword] = useState(false);
...
//         await login(values);
//       } catch (error) {
//         // Show toast notification on login failure
//         toastTrigger({
//           title: "Login failed",
//           description: error.message || "Invalid credentials",
//           status: "error", // optional, you can use to style toast if you want
//           duration: 5000,
//           isClosable: true,
//         });
//       }
...
//         <form onSubmit={handleSubmit}>
//           <CardContent className="space-y-4">
//             {/* Removed previous error alert here */}
