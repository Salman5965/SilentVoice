...
// import { ArrowLeft, Save, Eye, Plus, X, Loader2, FolderOpen, ChevronDown, Upload, Link, Image } from "lucide-react";
...
//   const isFormValid = title.trim().length > 0 && content.trim().length > 0 && category && category.length > 0;
